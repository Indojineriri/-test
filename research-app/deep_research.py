...
- 各事例の overview / challenges / solutions は具体的な数値・固有名詞・技術用語を含む 4〜6 個の箇条書きにする。
...
- overview（4〜6 個）: 何をするシステムか、入出力、対象タスク、規模、性能
- challenges（4〜6 個）: 既存技術の構造的限界、データ・物理・計算の制約
- solutions（4〜6 個）: 提案手法のキモ、技術要素、新規性
